...
# Aplikasi
p = date(21,2,2003)
print(Nextday(date(25,3,2877)))
print(Yesterday(date(1,3,2004)))
print(IsEqD(date(23,5,2007),date(23,5,2007)))
print(HariKe1900(date(14,2,2000)))
print(IsAfter(date(9,1,2005),date(9,1,2004)))
print(IsKabisat(p))
