...
//NIM  : 24060121140114 
//Deskripsi : Membuat kubus dengan setiap sisi memiliki gambar yang berbeda dan texture.
...
void initRendering() {
	...
	Image* img1 = loadBMP("ganyu.bmp");
	_sisi1Id = loadTexture(img1);
	delete img1;

	Image* img2 = loadBMP("marin.bmp");
	_sisi2Id = loadTexture(img2);
	delete img2;

	Image* img3 = loadBMP("hutao.bmp");
	_sisi3Id = loadTexture(img3);
	delete img3;

	Image* img4 = loadBMP("chaewon.bmp");
	_sisi4Id = loadTexture(img4);
	delete img4;

	Image* img5 = loadBMP("haewon.bmp");
	_sisi5Id = loadTexture(img5);
	delete img5;

	Image* img6 = loadBMP("logoa.bmp");
